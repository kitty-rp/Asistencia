 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="Asistencia.Presentacion.Turno.Listado"
 MasterPageFile="~/Adm.Master" StylesheetTheme="Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="Label2" runat="server" Text="Listado de Turnos"></asp:Label>
    ...
    <asp:GridView ID="gvListado" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="descricion" HeaderText="Descripción">
